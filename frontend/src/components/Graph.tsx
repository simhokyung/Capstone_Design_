...
const zoneList: Record<string, Zone[]> = {
  'pm25': [
    ...
    { min: 15, max: 25, color: '#D0FBD588' },
    { min: 25, max: 35, color: '#D0FBD588' },
    { min: 35, max: 50, color: '#D0FBD588' },
  ],
  'pm100': [
    { min: 0,  max: 15, color: '#83FB8088' },
    { min: 15, max: 30, color: '#83FB8088' },
    { min: 30, max: 50, color: '#83FB8088' },
    { min: 50, max: 70, color: '#83FB8088' },
    { min: 70, max: 100, color: '#83FB8088' },
  ],
  'co2': [
    { min: 0,  max: 400, color: '#F5F9FD88' },
    { min: 400, max: 1000, color: '#F5F9FD88' },
    { min: 1000, max: 2000, color: '#F5F9FD88' },
    { min: 2000, max: 3000, color: '#F5F9FD88' },
    { min: 3000, max: 4000, color: '#F5F9FD88' },
  ],
  'voc': [
    { min: 0,  max: 100, color: '#83FB8088' },
    { min: 100, max: 400, color: '#83FB8088' },
    { min: 400, max: 1000, color: '#83FB8088' },
    { min: 1000, max: 2000, color: '#83FB8088' },
    { min: 2000, max: 3000, color: '#D0FBD588' },
  ],
  'o3': [
    { min: 0,  max: 0.02, color: '#83FB8088' },
    { min: 0.02, max: 0.03, color: '#D0FBD588' },
    { min: 0.03, max: 0.09, color: '#F5F9FD88' },
    { min: 0.09, max: 0.12, color: '#F7DEDC88' },
    { min: 0.12, max: 0.15, color: '#F7A49988' },
  ],
  'no2': [
    { min: 0,  max: 0.02, color: '#83FB8088' },
    { min: 0.02, max: 0.03, color: '#D0FBD588' },
...
export const Graph: React.FC<GraphProps> =({data, type}) => {
